...
import citrusSteps.ComparePageStep;
import citrusSteps.HomePageStep;
import citrusSteps.ProductListPageStep;
import citrusSteps.ProductPageStep;
...
//    ComparePage comparePage;
    ...
    public void addProductToBasket() {
        homePageStep.clickOnLinkInMenu("Apple");
    ...
    public void addProductToBasketUsingSearch() {
        homePageStep.searchQuery();
        productListPageStep.closePopUp();
        productListPageStep.findeProduct(productName);


        String productName = productListPageStep.addToBasket();
        String productPrice = productListPageStep.addToBasket2();

        productListPageStep.verifyBasket(productPrice, productName);
